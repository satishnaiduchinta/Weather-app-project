...
const datetimeElement = document.querySelector(".weater__datetime");
const forecastElement = document.querySelector(".weather__forecast");
const iconElement = document.querySelector(".weather__icon");
const temperatureElement = document.querySelector(".weather__temparature");
...
const celsiusUnit = document.querySelector(".weather__unit__celsius");
const fahrenheitUnit = document.querySelector(".weather__unit__farenheit");

const apiKey = "53e9ecd3add2fa5b9a5c1d4667f5fa41";
